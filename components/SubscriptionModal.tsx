      ...
      <div className="relative w-full max-w-sm bg-slate-900 border border-slate-700 rounded-3xl p-6 shadow-2xl animate-fade-in-up">
        ...
        <div className="flex flex-col items-center text-center mt-2">
          ...
          <h2 className="text-xl font-bold text-white mb-2">
            Открыть "{pattern.name}"
          </h2>
          
          <p className="text-slate-400 text-sm mb-6">
            Получите доступ к продвинутой технике дыхания для глубокой релаксации и концентрации.
          </p>
          ...
          <button
            ...
            `}
          >
            {isLoading ? 'Обработка...' : `Оплатить ${pattern.price} Stars`}
          </button>
